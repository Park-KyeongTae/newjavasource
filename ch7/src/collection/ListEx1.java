 ...
 *   
 *  Set 인터페이스 : 순서가 유지하지 않음, 데이터 중복을 허용하지 않음
 *   구현클래스 : HashSet, TreeSet...
 *    
 *  Map 인터페이스 : key, value 의 쌍으로 이루어진데이터 집합
...
public class ListEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("size() "+list.size()); //배열의 length라고 생각
		...
		//remove(int index)		
		list2.remove(2);
		System.out.println("특정 위치에 요소 제거"+list2);
		//remove(Object o)
		list4.remove("바나나");
		System.out.println("특정 위치에 요소 제거"+list4);
		...
		//sort() 
		Collections.sort(list4); //오름차순 기본 ,내림차순을 원할 때는 기준 제공
