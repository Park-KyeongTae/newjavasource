...
public class MapEx1 {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			//value 해당하는 password입력받기
			System.out.println("비밀번호 : ");
			String password = sc.nextLine().trim(); // 홍길동  엔터 id="홍길동  "
			//map 입력받은 아이디가 id가 존재하지 않을 경우 "입력하신 아이디는 존재하지 않습니다. 다시 입력해주세요!
			//메시지 출력 후 다시 id 입력받기
			//containsKey(Object key) :  HashMap에 key를 포함하고 있느냐?
			...
			//get(Object key): key값을 반환, 못찾으면 null
